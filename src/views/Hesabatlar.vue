      ...
      >
        ...
        <template v-slot:item="{ item }">
          <tr class="green lighten-4">
            ...
            <td>{{ item.old_miqdar }}</td>
            <td>{{ item.new_miqdar }}</td>
            <td>{{ item.log_time }}</td>
...
export default {
  data() {
    return {
      ...
      headers: [
        { text: "#", value: "index" },
        { text: "ID", value: "l.id" },
        { text: "Əməliyyat", value: "name" },
        { text: "Məhsul Tipi", value: "mehsultipi" },
        { text: "Əvvəlki Miqdar", value: "old_miqdar", filterable: false },
        { text: "Yeni Miqdar", value: "new_miqdar", filterable: false },
        { text: "Tarix", value: "log_time", filterable: false },
      ],
    };
  },
  ...
  methods: {
    refreshDataDelayed() {
      ...
      setTimeout(() => {
        axios.get(BASE_PATH + "/reports/anbarlogs").then((result) => {
